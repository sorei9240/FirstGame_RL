...
The agent is rewarded 1 each time the opponent is hit, and penalized -1 each time it is hit. There is also a -0.1 penalty for missed shots to help the agent learn to aim. There is a +50 reward for winning the game and a -50 penalty for losing.
